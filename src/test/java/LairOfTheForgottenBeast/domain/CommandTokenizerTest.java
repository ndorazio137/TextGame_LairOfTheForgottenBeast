...
public class CommandTokenizerTest {
  ...
  /**
   * Tests a String consisting of only alphabet characters and one space as input to the
   * commandTokenizer.
   * 
   * @since 1.0.0
   */
  ...
  /**
   * Tests a String of alphabet characters with a space and trailing white space as input to the
   * commandTokenizer.
   * 
   * @since 1.0.0
   */
  ...
  /**
   * Tests a String of alphabet characters with a space and leading white space as input to the
   * commandTokenizer.
   * 
   * @since 1.0.0
   */
  ...
  /**
   * Tests a String of alphabet characters with a space and both leading and trailing white space as
   * input to the commandTokenizer.
   * 
   * @since 1.0.0
   */
  @Test
  ...
  /**
   * Tests a String with more than two words and spaces as input to the commandTokenizer.
   * 
   * @since 1.0.0
   */
  @Test
