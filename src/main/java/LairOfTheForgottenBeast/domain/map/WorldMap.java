...
public class WorldMap {
  ...
  /**
   * Returns the <code>Room</code> object at the specified coordinates in <code>WorldMap</code>. The
   * coords arguments should be an <code>int[]</code> type. This method will return null if the
   * coordinates are out of bounds. If no <code>Room</code> is found, this method should return
   * null.
   * 
  ...
  /**
   * Returns the <code>Room</code> object at the specified coordinates in <code>WorldMap</code>. The
   * x and y arguments should be an <code>int</code> type. This method will return null if the
   * coordinates are out of bounds. If no <code>Room</code> is found, this method should return
   * null.
   * 
   ...
   * The x and y arguments should be <code>int</code> type. This method will return null if the
  ...
  /**
   * Returns whether the coordinates are valid within WorldMap. If any coordinate is < 0 or > the
   * max world size, this method returns false. Otherwise this method returns true. If any argument
   * is <code>null</code>, this method's behavior is undefined.
   * 
  ...
  /**
   * Returns a <code>Room</code> object with a matching name from the WorldMap. The name argument
   * should be the name of a <code>Room</code> object. If an empty <code>String</code> is passed,
   * this method will return null. If name is <code>null</code>, this method will return null.
   * 
  ...
  /**
   * Returns an int array with the coordinates of the specified Room. The room argument should be a
   * <code>Room</code> object. If an empty <code>String</code> is passed, this method will return
   * null. If name is <code>null</code>, this method will return null.
   * 
  ...
  public String getPassableDirectionMessage(RoomDynamic room) {
    ...
    if (south) {
      if ((north && east) || (north && west) || (east && west))
        passableDirectionMessage += ", ";
      if (north || east || west)
        passableDirectionMessage += " and ";
