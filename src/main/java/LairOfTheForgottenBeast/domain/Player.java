...
public class Player {
   ...
   * @return A boolean expression (sanity check) representing whether the item was successfully
   *         equipped.
   */
  ...
  /**
   * Moves the equipped item to the players inventory while removing it from the weapon players
   * slot.
   * 
   * @return A boolean expression (sanity check) representing if the item was successfully
   *         unequipped and moved to the inventory.
   */
