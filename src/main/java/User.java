...
public class User {
	 ...
	 * @return A boolean expression (sanity check) representing if the new password was successfully set.
	 */
	 ...
	 * @return A boolean expression (sanity check) representing that the display name was successfully set.
	 */
